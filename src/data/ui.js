...
export const ui = {
  ...
  // AND THE RALLY THUG'S, which takes `fit` like the chevrons and for the same
  // reason: 44 x 30 is the widest mark in the set, a sword with an arrow beside it
  ...
  //
  // THE SAME TRIM TO THE PIXEL as the health boost it replaces — the artist drew the
  // new mark into the same box — so nothing about the row's geometry moved.
  status_rally:    { trim: [234, 241, 44, 30], fit: STATUS_H },
